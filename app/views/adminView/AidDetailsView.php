        ...
        <div class="max-w-4xl mx-auto px-6">
            <div class="bg-white shadow-lg rounded-lg border border-gray-200">
                ...
                <div class="px-6 py-4 border-b border-gray-200 flex justify-between items-center">
                    ...
                    <div class="space-x-3">
                        <a href="<?php echo BASE_URL; ?>/admin/aid?action=accept&id=<?php echo htmlspecialchars($aidRequest['id']); ?>" 
                ...
                <div class="p-6">
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <?php if (!empty($aidRequest['link'])): ?>
                                <div class="flex items-center space-x-2">
                                    <span class="text-gray-700">Document:</span>
                                    <a href="<?php echo htmlspecialchars($aidRequest['link']); ?>" target="_blank" 
